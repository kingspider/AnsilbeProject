Ssc.Postgres install_standalone Role
========================
...
```yaml
- name: Initialize the install_standalone role from ssc.postgres
  hosts: servers
  gather_facts: false
  tasks:
    - name: Trigger invocation of install_standalone role
      ansible.builtin.include_role:
        name: ssc.postgres.install_standalone
      vars:
        run_x: 42
```
